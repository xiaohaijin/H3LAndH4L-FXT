#!/bin/csh
# -------------------------------------- 
# Script generated on Mon Nov 26 13:04:19 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/jhai/STAR/FixedTarget/H3LAndH4L-FXT/Hypertriton/input; condor_submit /star/u/jhai/STAR/FixedTarget/H3LAndH4L-FXT/Hypertriton/input/runinfo/csh/sched041239ADF7763BC03611C85295C7C045_82_181.condor
# --------------------------------------
...
setenv FILEBASENAME "st_physics_adc_16140037_raw_4500002"
setenv FILELIST "/star/u/jhai/STAR/FixedTarget/H3LAndH4L-FXT/Hypertriton/input/runinfo/list/sched041239ADF7763BC03611C85295C7C045_84.list"
setenv FILELIST_ALL "/star/u/jhai/STAR/FixedTarget/H3LAndH4L-FXT/Hypertriton/input/runinfo/csh/sched041239ADF7763BC03611C85295C7C045.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "041239ADF7763BC03611C85295C7C045_84"
setenv JOBINDEX "84"
setenv LOGGING "STD"
setenv REQUESTID "041239ADF7763BC03611C85295C7C045"
setenv SUBMITATTEMPT "1"
setenv SUBMITTINGDIRECTORY "/star/u/jhai/STAR/FixedTarget/H3LAndH4L-FXT/Hypertriton/input"
setenv SUBMITTINGNODE "rcas6009.rcf.bnl.gov"
setenv SUBMIT_TIME "2018-11-26 18:04:19"
setenv SUMS_AUTHENTICATED_USER "jhai@rhic.bnl.gov"
setenv SUMS_USER "jhai"
setenv SUMS_nProcesses "282"
setenv SUMS_name "null"
setenv USEXROOTD "1"
setenv INPUTFILE0 "root://xrdstar.rcf.bnl.gov:1095//home/starreco/reco/fixedTarget2015/ReversedFullField/P16ia/2015/140/16140037/st_physics_adc_16140037_raw_4500002.MuDst.root"
...
# User command BEGIN ----------------------------->
		...
		set mainDir = /star/u/jhai/STAR/FixedTarget/H3LAndH4L-FXT/Hypertriton
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/*.root )
         ...
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/jhai/scratch/FixedTarget/H3L/output/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/jhai/scratch/FixedTarget/H3L/output/"
         endif
